...
public class Project1 {
	...
	public void charTransition(char c){
		   ...
		   gTable.setStartState(rootNodeChar.stateID);
		   gTable.setFinalState(endNodeChar.stateID);
	...
	public void concatState(){
	   ...
	   gTable.setFinalState(nodeBFinal.stateID);
	}
	public void kleene(){
		   ...
		   //Save State on stack for Operator
		    ...
		    stateHistory.push(kleeneFinalPair);
			   ...
			   gTable.setFinalState(newFinal.stateID);
	}
		   ...
		   //Save State on stack for Operator
		    ...
		    stateHistory.push(orPairFinal);
			  ...
			  gTable.InsertEdgeByWeight(firstEndVertex,endNodeOr,empty);
			   ...
			   gTable.setFinalState(endNodeOr.stateID);
	}
