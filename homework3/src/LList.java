...
public class LList<T> 
{
  ...
  // exercise -------------------------
	public LList(Packet[] items, int numberOfItems)
	{
		clear();
  ...
  // ----------------------------------
	...
	public boolean add(Packet newEntry) 	      // OutOfMemoryError possible
	{
  ...
  public boolean add(int newPosition, Packet newEntry) // OutOfMemoryError possible	                                                 
	{
	...
	public Packet remove(int givenPosition)
	{
	  Packet result = null;                 // return value
	...
	public boolean replace(int givenPosition, Packet newEntry)
	{
		boolean isSuccessful = true;
  ...
  public Packet getEntry(int givenPosition)
  {
  	Packet result = null;  // result to return
	...
	public boolean contains(Packet anEntry)
	{
		boolean found = false;
  ...
  public void display()
  {
	  ...
	  Node currentNode = firstNode;
		...
		{ 
			System.out.println(currentNode.data.printResults());
		  currentNode = currentNode.next; 
		} // end while  
...
//	System.out.println();
  ...
  private void displayChain(Node nodeOne) 
	...
	private class Node 
	{
	  private Packet data; // entry in list
	  private Node next; // link to next node

		private Node(Packet dataPortion)
		{
			data = dataPortion;
			next = null;	
		} // end constructor
		
		private Node(Packet dataPortion, Node nextNode)
		{
			data = dataPortion;
			next = nextNode;	
		} // end constructor
