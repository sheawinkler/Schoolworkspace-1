...
public class NoteEdit extends Activity {
	...
	String userName;// = getIntent().getStringExtra(NoteList.USER);
	long noteID;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		userName = getIntent().getStringExtra(NoteList.USER);
		noteID = getIntent().getLongExtra(NoteList.NOTE_EDIT, 0);
